...
final class SourceFileBuilder {
    ...
    void emitPackagePrefix() {
        ...
        appendLines("""
            // Generated by jextract\{SHOW_GENERATING_CLASS ? " (via \{getClass().getName()})" : ""}
    ...
    public JavaSourceFile toFile(String suffix, Function<String, String> finisher) {
        return new JavaSourceFile("\{className}\{suffix}".join(), packageName, finisher.apply(sb.toString()));
    }
